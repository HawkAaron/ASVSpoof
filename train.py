...
def online_iter(batchsize, feat):
    ...
    train_iter = chainer.iterators.MultiprocessIterator(train, batchsize, n_prefetch=2)
    dev_iter = chainer.iterators.MultiprocessIterator(dev, batchsize, n_prefetch=2, repeat=False, shuffle=False)
